...
| [`team/branch_state_encoder_eval_changes.md`](team/branch_state_encoder_eval_changes.md) | (branch `state-encoder-eval`) re-running the dense work against the live state machine — four S6 rerank variants net-zero-or-worse at full scale, but the S5 dense retrieval route clears the noise floor: +0.0263 overall, +0.0561 browsing |
